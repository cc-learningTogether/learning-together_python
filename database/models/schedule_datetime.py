...
class ScheduleDatetime(db.Model):
    ...
    user_opening_slot = db.Column(db.Integer, db.ForeignKey('users_profiles.id'), default=-1)
    user_booking_slot = db.Column(db.Integer, db.ForeignKey('users_profiles.id'), default=-1)
