        ...
        try:
            ...
            for i in range(len(schedule_list)):
                if schedule_list[i]["user_booking_slot"] == None: # If the slot is open
                    data = {}
                    data["schedule_id"] = schedule_list[i]["id"]
